...
Um die Leistung des \ac{SLAM} Algorithmus mit der Azure Kinect Kamera zu beurteilen, haben wir auch den ORB-SLAM3 Algorithmus mit Testdaten laufen lassen. Genauer gesagt mit dem Testdatensatz Floor1 von der \ac{TUM} von \cite{testdatatum}.
