...
\section{Sensoren} \label{sensoren:section}
    ...
    \subsection{Gyroskyp} \label{gyroskop:subsection}

    \subsection{Laserscanner} \label{laserscanner:subsection}
...
\begin{figure}[htpb]
    \centering
    \includegraphics[width=8cm,keepaspectratio,angle=0]{images/coex_clover_kit.jpg}
