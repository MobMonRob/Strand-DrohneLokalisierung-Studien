...
\todo{Verein Deutscher Ingeneureum?}
...
In der Robotikforschung wird \ac{SLAM} als grundlegende Fähigkeit für autonome Roboter betrachtet. Frühe Arbeiten zu \ac{SLAM} nutzten hauptsächlich Laserscanner, jedoch hat das Feld aufgrund von Fortschritten in der Computer Vision und verbesserter Prozessoren schnell auf Kameras umgestellt. Die meisten visuellen \ac{SLAM}-Methoden basieren auf Merkmalsabgleich und Mehrsichtgeometrie, was einige Einschränkungen für monokulare \ac{SLAM} mit sich bringt. Dies kann teilweise durch zusätzliche Sensoren oder Vorwissen über das System oder die Szene gelöst werden.

In der Robotikforschung wird SLAM als grundlegende Fähigkeit für autonome Roboter betrachtet. Frühe Arbeiten zu SLAM nutzten hauptsächlich Laserscanner, jedoch hat das Feld aufgrund von Fortschritten in der Computer Vision und verbesserter Prozessoren schnell auf Kameras umgestellt. Die meisten visuellen SLAM-Methoden basieren auf Merkmalsabgleich und Mehrsichtgeometrie, was einige Einschränkungen für monokulare SLAM mit sich bringt. Dies kann teilweise durch zusätzliche Sensoren oder Vorwissen über das System oder die Szene gelöst werden.

\subsubsection{Herausforderungen und Lösungen in \ac{VO} und \ac{VSLAM}}

Die meisten visuellen SLAM-Methoden basieren auf Merkmalsabgleich und Mehransichtsgeometrie. Dies bringt einige Herausforderungen und Einschränkungen mit sich, insbesondere für monokulare SLAM. Zu diesen Herausforderungen gehören die Notwendigkeit einer großen Basislinienbewegung, um ausreichend Parallaxe für eine zuverlässige Tiefenschätzung zu erzeugen, und die Unbeobachtbarkeit der Skala. Diese Probleme können teilweise durch den Einsatz zusätzlicher Sensoren, wie Stereo-Kameras und Trägheitsmesseinheiten (IMUs), oder durch Vorwissen über das System oder die Szene gelöst werden. Ein weiteres Problem ist die dichte Rekonstruktion von Bereichen mit geringer Textur.

\subsubsection{Der Nutzen von RGB-D Sensoren}
...
\subsection{Monocular \ac{VSLAM}}

\todo{Grundlegenden Unterscheidungen SLAM}
\todo{Unterscheidung visual inertial}
\todo{loop closure und das gedöns erklären}
