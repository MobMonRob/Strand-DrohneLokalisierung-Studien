...
Der Coex Pix Flight Controller wird für den Betrieb von Drohnen und anderen Fluggeräten verwendet werden. Hierbei basiert dieser auf der PX4 Software. Der Flight Controller einhaltet verschiedene Sensoren, hierzu gehören ein Accelerometer, Gyroskop und ein Magnetometer. Damit soll ein stabiler Flug ermöglicht werden, wobei verschiedene Modi genutzt werden können. Zu diesen zählen unter anderem ein Stabilisierungsmodus oder auch ein Modus, in dem eigene Flugmanöver getestet beziehungswiese genutzt werden können.
