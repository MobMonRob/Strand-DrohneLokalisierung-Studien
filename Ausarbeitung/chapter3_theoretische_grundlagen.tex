...
Dank seiner leistungsstarken Funktionen und Flexibilität ist \ac{ROS} zu einem der wichtigsten Frameworks für die Robotik-Entwicklung geworden und wird in vielen Anwendungen eingesetzt, von industriellen Robotern bis hin zu autonomen Fahrzeugen.
    ...
    \todo{können wie eventuell einfach weglassen ? Hat ja nix mit dem eigentlichen Verfahren zu tun}
    ...
    \todo{lassen wenn nicht verwendet?}
...
\subsubsection{Anforderungen an SLAM Systeme auf Multicoptern}
...
\end{description}
\label{fig:slam-sensors}\caption{SLAM Sensoren}
\end{figure}


\subsubsection{Punktwolkentransformation bei Kameras}
